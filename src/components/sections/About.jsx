...
const About = () => {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <section
        id="about"
        className={`${isDarkMode ? "bg-black" : "bg-white"} py-20`}
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* About Me Section */}
            <motion.div variants={fadeIn("up", 0)} className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  >
                    ...
                    design and a strong foundation in modern web technologies.
                    My journey in web development started with a deep curiosity
            ...
            {/* Services Section */}
            <motion.div variants={fadeIn("up", 0.2)} className="space-y-10">
              <div className="space-y-4">
                <h2
